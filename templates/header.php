<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container">
    <a href="http://planview.com" target="_blank"><i class="fa fa-arrow-left"></i>  Planview.com</a>
  </div>
</nav>
...
<header class="banner navbar navbar-default navbar-static-top" role="banner">
  <div class="container">
    ...
    <nav class="collapse navbar-collapse" role="navigation" id="mainnav">
      ...
      <ul class="nav navbar-nav navbar-right icons">
        <li class="menu-item menu-subscribe"><a title="Subscribe" data-toggle="modal" data-target="#subscribeModal"><i class="fa fa-envelope-square"></i>  <span>Subscribe</span></a></li>
      </ul>
